...
class Skeleton:
    ...
    def forward_kinematics(self, rotations, root_positions):
        ...
        Arguments (where N = batch size, J = number of joints):
         -- rotations: (N, J, 4) tensor of unit quaternions describing the local rotations of each joint.
         -- root_positions: (N, 3) tensor describing the root joint positions.
        """
        ...
        expanded_offsets = self._offsets.expand(rotations.shape[0], self._offsets.shape[0], self._offsets.shape[1])
